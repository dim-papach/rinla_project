...
from fyf.config import CosmicConfig, SatelliteConfig, INLAConfig
...
class FitsProcessor:
    ...
    def build_inla_command(self, inla_script_path: str, inla_config: INLAConfig, path_file: str) -> list:
